      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-5xl font-bold text-gray-800 font-serif">
            ModernNest<span className="text-rose-400">Decor</span> Blog
          </h1>
          <p className="text-gray-600 mt-2 text-lg">
            Home decor insights, trends, and inspiration for modern living
          </p>
        </div>
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${
                selectedCategory === null
                  ...
                  : 'bg-white text-gray-600 hover:bg-rose-50 hover:text-rose-400 shadow-sm'
              }`}
            >
              All Posts
            </button>
            ...
            >
              <div className="md:flex">
                ...
                <div className="md:w-2/3 p-8">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 mb-4 hover:text-rose-400 transition-colors font-serif">
                  ...
                  <Link
                    to={`/blog/${post.id}`}
                    className="inline-flex items-center gap-2 bg-rose-400 text-white px-6 py-2 rounded-lg font-semibold hover:bg-rose-500 transition-colors"
                  >
                    Read Full Article
